# -*- coding: utf-8 -*-
"""Reusable V_top_layer feature extractor for Qwen-style vision-language models."""
...
class VTopLayerExtractor:
    """Capture top-layer hidden states corresponding to image tokens."""
    ...
    def _find_last_transformer_layer(self):
        """Locate the last transformer layer inside the language model."""
    ...
    def capture(self, inputs: Dict[str, torch.Tensor], image_token_mask: torch.Tensor) -> torch.Tensor:
        """Capture V_top_layer features as a CPU tensor of shape (N_img, D)."""
        ...
        # 确保 image_token_mask 与 hidden_states 在同一设备上
