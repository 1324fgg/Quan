...
def main():
    ...
    # NOTE: We do NOT add <lvr> token for text-only SFT
    ...
    # 3. Model - Use standard Qwen2.5-VL (not ViLR wrapper)
    ...
    # 4. Trainer - Use standard Trainer (not LaViTTrainer, since this is text-only baseline)
